...
<!--   ******************************************************************************
       * sitephotos.php                                                  10/22/2009 *
       * For www.myblackjeep.com by Mark Coulter                                    *
       * Photo gallery - Photos Used For Random Photo Shown In The Header           *
       *                                                                            *
       *                                                                            *
       ****************************************************************************** -->
<title>My Black Jeep - Photo Galley - Photos Used For Random Photo Shown In The Header</title>
...
<div id="page">
    ...
    <div id="mainbody">
        ...
        <div id="content">
            <h3><a href="/gallery.php">Photo Gallery</a> &gt; Photos Used For Random Photo Shown In The Header</h3>
            <?php
                // **********************************************************************************
                // Build the index page of Photos.
                // The text file /gallery/albums/sitephotos.txt contains the list of Photos.
                ...
                // **********************************************************************************
                $fh = fopen($_SERVER['DOCUMENT_ROOT']."/gallery/albums/sitephotos.txt", "r");
