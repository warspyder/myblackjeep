...
<!--   ******************************************************************************
       * winchmount         .php                                         10/22/2009 *
       * For www.myblackjeep.com by Mark Coulter                                    *
       * Photo gallery - Front Bumper And Winch Plate                               *
       *                                                                            *
       *                                                                            *
       ****************************************************************************** -->
<title>My Black Jeep - Photo Galley - Front Bumper And Winch Plate</title>
...
<div id="page">
    ...
    <div id="mainbody">
        ...
        <div id="content">
            <h3><a href="/gallery.php">Photo Gallery</a> &gt; Front Bumper And Winch Plate</h3>
            <?php
                // **********************************************************************************
                // Build the index page of Photos.
                // The text file /gallery/albums/winchmount.txt contains the list of Photos.
                ...
                // **********************************************************************************
                $fh = fopen($_SERVER['DOCUMENT_ROOT']."/gallery/albums/winchmount.txt", "r");
