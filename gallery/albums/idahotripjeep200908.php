...
<!--   ******************************************************************************
       * idahotripjeep200908.php                                         08/27/2009 *
       * For www.myblackjeep.com by Mark Coulter                                    *
       * Photo gallery - Photos of the Jeep August 2009                             *
       *                                                                            *
       ...
       *                                                                            *
       ****************************************************************************** -->
<title>My Black Jeep - Photo Galley - Photos of the Jeep August 2009</title>
...
<div id="page">
    ...
    <div id="mainbody">
        ...
        <div id="content">
            <h3><a href="/gallery.php">Photo Gallery</a> &gt; Photos of the Jeep August 2009</h3>
            <?php
                // **********************************************************************************
                // Build the index page of Photos.
                // The text file /gallery/albums/idahotripjeep200908.txt contains the list of Photos.
                ...
                // **********************************************************************************
                $fh = fopen($_SERVER['DOCUMENT_ROOT']."/gallery/albums/idahotripjeep200908.txt", "r");
