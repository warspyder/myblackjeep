...
<!--   ******************************************************************************
       * trailerbuild.php                                                08/30/2009 *
       * For www.myblackjeep.com by Mark Coulter                                    *
       * Trailer Build Article                                                      *
       *                                                                            *
       *                                                                            *
       *                                                                            *
       *                                                                            *
       ...
       *                                                                            *
       ****************************************************************************** -->
<title>My Black Jeep - Trailer Build</title>
...
<div id="page">
    ...
    <?php include $_SERVER['DOCUMENT_ROOT'].'/include/header.inc'; /* Photo, Navigation Bar, and Logo include file*/ ?>

    <div id="mainbody">

        <?php include $_SERVER['DOCUMENT_ROOT'].'/include/leftcol.inc'; /* Left Column include file*/ ?>

        <div id="content">
            <h3>Trailer Build August 2009</h3>
            ...
            <h4>After Thoughts</h4>
                ...
                <p>Here are a few pictures of the <a href="/gallery/albums/trailerbuild200908.php">Offroad Trailer Build.</a></p>
        </div>  <!-- end of content -->
        <?php include $_SERVER['DOCUMENT_ROOT'].'/include/footer.inc'; /* Footer include file*/ ?>
